  ...
  return (
    <div className="pb-10">
      ...
      <section className="p-10 lg:py-10 lg:px-20">
        <p className='text-2xl font-semibold text-gray-400 py-3 font-serif'>Top Meels</p>
        <MultiItemCarsoul />
      </section>


        <section className='px-5 lg:px-20 pt-5'>
            <h1 className='text-2xl font-semibold text-gray-400 py-3 font-serif'>Order From Our Handpicked Favourites</h1>
